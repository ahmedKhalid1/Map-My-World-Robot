...
![robot_model](photos/garage_explore.png)
...
![kitchen_3d](photos/3d-map.png)

### Note on the RTAB Map Database Files
The files were too large to host on Github, so I uploaded them to Google Drive and the sharing link is [here]https://drive.google.com/file/d/1kWlC5CdOrbdKblN0IiVoP8pLaOwIMDZy/view?usp=sharing).
